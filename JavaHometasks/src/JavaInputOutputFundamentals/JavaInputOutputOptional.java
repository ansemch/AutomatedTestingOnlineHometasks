...
public class JavaInputOutputOptional {
    ...
    public static void main (String [] args) throws FileNotFoundException {
        ...
        while(sc.hasNext()) printer.write(sc.nextLine().replaceAll("public","private")+"\n");
        printer.close();
        sc = new Scanner(new File("data/inputJava.txt"));
        printer = new PrintWriter(new File("data/outputJavaStringsReverse.txt"));
        while(sc.hasNext()) printer.write( new StringBuffer (sc.nextLine()).reverse()+"\n");
        printer.close();
    }
}